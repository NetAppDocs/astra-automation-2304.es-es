...
* "no gestionado" - El backend de almacenamiento se encuentra en estado "descubierto", no está bajo gestión y es elegible para gestión
...
Cadena JSON que indica si este Storage Backend admite FlexClone.
...
Cadena JSON que contiene la dirección IP utilizada para conectarse a este clúster ONTAP.
