...
summary: Recupera un activo de aplicación para una instantánea de aplicación y una app 
---
= Recupera un activo de aplicación para una instantánea de aplicación y una app
:allow-uri-read: 
