...
summary: Enumera los hooks de ejecución de una app 
---
= Enumera los hooks de ejecución de una app
:allow-uri-read: 
...
| artículos | array[Cualquiera de: link:#executionHook_1_2_get_response_body["executionHook_1.2_get_response_body"], array[]] | Verdadero  a| 
...
* Longitud mínima: 1
* Longitud máxima: 63 El nombre debe ser único en todos los recursos de gancho de ejecución.
...
* "post" - El gancho de ejecución se ejecutará después de la acción especificada. Los valores para la acción "snapshot" son "pre" y "post". Los valores para la acción "backup" son "pre" y "post". El valor para la acción "restore" es "post".
