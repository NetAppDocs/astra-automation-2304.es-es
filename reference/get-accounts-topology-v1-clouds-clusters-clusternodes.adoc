...
summary: Enumera los nodos del clúster de una nube 
---
= Enumera los nodos del clúster de una nube
:allow-uri-read: 
...
| nombre | cadena | Verdadero  a| 
Cadena JSON que contiene un valor que indica el nombre Kubernetes para el nodo. Los valores definidos son:
...
Cadena JSON que contiene un valor que indica el número de CPUs asignadas al nodo. Los valores definidos son:
