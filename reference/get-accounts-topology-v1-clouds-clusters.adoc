...
summary: Enumera los clusters de una nube 
---
= Enumera los clusters de una nube
:allow-uri-read: 
...
| artículos | array[Cualquiera de: link:#cluster_1_5_get_response_body["cluster_1.5_get_response_body"], array[]] | Verdadero  a| 
